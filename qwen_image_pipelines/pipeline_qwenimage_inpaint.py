# Copied from diffusers/pipelines/qwenimage/pipeline_qwenimage_inpaint.py
import inspect
...
from .utils import retrieve_latents, calculate_shift, retrieve_timesteps, get_transformer_text_seq_kwargs
