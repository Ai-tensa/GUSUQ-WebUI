...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffusers import QwenImageEditPlusInpaintPipeline
        >>> from diffusers.utils import load_image

        >>> pipe = QwenImageEditPlusInpaintPipeline.from_pretrained("Qwen/Qwen-Image-Edit-2509", torch_dtype=torch.bfloat16)
        >>> pipe.to("cuda")
        >>> image = load_image(
        ...
        >>> image = pipe(image, prompt, mask_image=mask, num_inference_steps=50).images[0]
...
class QwenImageEditPlusInpaintPipeline(DiffusionPipeline, QwenImageLoraLoaderMixin):
    ...
    def prepare_latents(
        ...
        if images is not None:
            ...
            for image in images:
                ...
                if first_image_latents is None:
                    first_image_latents = image_latents
        ...
        if latents is None:
            ...
            first_image_latents = first_image_latents.transpose(1, 2)  # [B,1,z,H',W']
